...
var require_collapse = __commonJS({
  "node_modules/bootstrap/js/dist/collapse.js"(exports, module) {
    (function(global, factory) {
      ...
      index.defineJQueryPlugin(Collapse2);
      return Collapse2;
    });
  }
});
  ...
  "node_modules/bootstrap/js/dist/carousel.js"(exports, module) {
    (function(global, factory) {
      ...
      class Carousel2 extends BaseComponent__default.default {
        ...
        static jQueryInterface(config) {
          return this.each(function() {
            const data = Carousel2.getOrCreateInstance(this, config);
      ...
      index.defineJQueryPlugin(Carousel2);
      return Carousel2;
    });
  }
});
...
var require_dropdown = __commonJS({
  "node_modules/bootstrap/js/dist/dropdown.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory((init_lib(), __toCommonJS(lib_exports)), require_util(), require_event_handler(), require_manipulator(), require_selector_engine(), require_base_component()) : typeof define === "function" && define.amd ? define(["@popperjs/core", "./util/index", "./dom/event-handler", "./dom/manipulator", "./dom/selector-engine", "./base-component"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.Dropdown = factory(global["@popperjs/core"], global.Index, global.EventHandler, global.Manipulator, global.SelectorEngine, global.BaseComponent));
      ...
      index.defineJQueryPlugin(Dropdown2);
      return Dropdown2;
    });
  }
});
...
var require_template_factory = __commonJS({
  "node_modules/bootstrap/js/dist/util/template-factory.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_sanitizer(), require_util(), require_selector_engine(), require_config()) : typeof define === "function" && define.amd ? define(["./sanitizer", "./index", "../dom/selector-engine", "./config"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.TemplateFactory = factory(global.Sanitizer, global.Index, global.SelectorEngine, global.Config));
...
var require_tooltip = __commonJS({
  "node_modules/bootstrap/js/dist/tooltip.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory((init_lib(), __toCommonJS(lib_exports)), require_util(), require_sanitizer(), require_event_handler(), require_manipulator(), require_base_component(), require_template_factory()) : typeof define === "function" && define.amd ? define(["@popperjs/core", "./util/index", "./util/sanitizer", "./dom/event-handler", "./dom/manipulator", "./base-component", "./util/template-factory"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.Tooltip = factory(global["@popperjs/core"], global.Index, global.Sanitizer, global.EventHandler, global.Manipulator, global.BaseComponent, global.TemplateFactory));
      ...
      const Manipulator__default = _interopDefaultLegacy(Manipulator);
      const BaseComponent__default = _interopDefaultLegacy(BaseComponent);
      const TemplateFactory__default = _interopDefaultLegacy(TemplateFactory);
      const NAME = "tooltip";
...
var require_popover = __commonJS({
  "node_modules/bootstrap/js/dist/popover.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_util(), require_tooltip()) : typeof define === "function" && define.amd ? define(["./util/index", "./tooltip"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.Popover = factory(global.Index, global.Tooltip));
...
var useEventListener = (element, event, callback) => {
  onMounted(() => {
    var _a;
...
var BvEvent = class {
  constructor(eventType, eventInit = {}) {
    ...
    __publicField(this, "vueTarget", null);
    if (!eventType) {
      throw new TypeError(
...
var resolveAriaInvalid = (ariaInvalid, state) => {
...
var _isObject = (item) => item && typeof item === "object" && item.constructor === Object;
var mergeDeep = (target, source, extendArray = true) => {
...
var toInteger = (value, defaultValue = NaN) => Number.isInteger(value) ? value : defaultValue;
...
var omit = (obj, props) => Object.keys(obj).filter((key) => props.indexOf(key) === -1).reduce((result, key) => ({ ...result, [key]: obj[key] }), {});
...
var pluckProps = (keysToPluck, objToPluck, transformFn = (x) => x) => (isArray(keysToPluck) ? keysToPluck.slice() : Object.keys(keysToPluck)).reduce(
  (memo, prop) => {
...
var resolveBooleanish = (input) => typeof input === "boolean" ? input : input === "" ? true : input === "true" ? true : false;
...
var _getComputedAriaInvalid = (items) => computed(() => resolveAriaInvalid(items.ariaInvalid, items.state));
...
var getInputClasses = (items) => computed(() => ({
...
var getGroupAttr = (items) => computed(() => {
  var _a;
  return {
...
var slotsToElements = (slots, nodeType, disabled) => slots.filter((e) => e.type.name === nodeType).map((e) => {
  const txtChild = (e.children.default ? e.children.default() : []).find(
    (e2) => e2.type.toString() === "Symbol(Text)"
  );
  return {
    props: {
      disabled,
...
var bindGroupProps = (el, idx, props, computedName, computedId) => ({
  ...el,
  props: {
...
var useId = (id, suffix) => computed(() => (id == null ? void 0 : id.value) || getID(suffix));
...
var useBooleanish = (el) => computed(() => resolveBooleanish(el.value));
var _hoisted_1$J = ["id"];
...
var _hoisted_1$I = { class: "accordion-item" };
var _hoisted_2$p = ["id"];
var _hoisted_3$a = ["aria-expanded", "aria-controls"];
var _hoisted_4$6 = { class: "accordion-body" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$I, [
        createBaseVNode("h2", {
          ...
          withDirectives((openBlock(), createElementBlock("button", {
            class: normalizeClass(["accordion-button", { collapsed: !unref(visibleBoolean) }]),
            type: "button",
            "aria-expanded": unref(visibleBoolean) ? "true" : "false",
...
var _sfc_main$1q = defineComponent({
  __name: "BAlert",
  props: {
  ...
  setup(__props, { emit }) {
    ...
    useBooleanish(toRef(props, "fade"));
    ...
    const isAlertVisible = computed(() => !!props.modelValue || showBoolean.value);
    onBeforeUnmount(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      return unref(isAlertVisible) ? (openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "default"),
        unref(dismissibleBoolean) ? (openBlock(), createElementBlock("button", {
          key: 0,
          type: "button",
          class: "btn-close",
...
var _sfc_main$1o = defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const computedSize = computed(
      () => (parentData == null ? void 0 : parentData.size) ? parentData.size : computeSize(props.size)
    );
    const computedVariant = computed(
      () => (parentData == null ? void 0 : parentData.variant) ? parentData.variant : props.variant
    );
    const computedRounded = computed(
      () => (parentData == null ? void 0 : parentData.rounded) ? parentData.rounded : props.rounded
    );
    ...
    const badgeStyle = computed(() => {
      ...
      return {
        fontSize: fontSize || "",
        top: badgeTopBoolean.value ? offset2 : "",
        bottom: badgeTopBoolean.value ? "" : offset2,
        left: badgeLeftBoolean.value ? offset2 : "",
        right: badgeLeftBoolean.value ? "" : offset2
      };
    });
    ...
    const tag = computed(() => buttonBoolean.value ? props.buttonType : "span");
    ...
    const clicked = (e) => {
      if (!disabledBoolean.value && buttonBoolean.value)
        emit("click", e);
    };
    const onImgError = (e) => emit("img-error", e);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createTextVNode(toDisplayString(__props.badgeLeft) + " " + toDisplayString(unref(badgeLeftBoolean)) + " ", 1),
        (openBlock(), createBlock(resolveDynamicComponent(unref(tag)), mergeProps({
          ...
          default: withCtx(() => [
            unref(hasDefaultSlot) ? (openBlock(), createElementBlock("span", _hoisted_1$G, [
              renderSlot(_ctx.$slots, "default")
            ])) : __props.src ? (openBlock(), createElementBlock("span", _hoisted_2$o, [
              createBaseVNode("img", {
                src: __props.src,
                alt: __props.alt,
                onError: onImgError
...
var _sfc_main$1n = defineComponent({
  ...
  setup(props, { emit, attrs }) {
    ...
    const routerAttr = computed(() => ({
      ...
      "tabindex": disabledBoolean.value ? "-1" : typeof attrs.tabindex === "undefined" ? null : attrs.tabindex,
...
function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.tag === "router-link" ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.tag), mergeProps({ key: 0 }, _ctx.routerAttr, { custom: "" }), {
    ...
    key: 1,
    ref: "link",
    class: { active: _ctx.activeBoolean, disabled: _ctx.disabledBoolean }
...
var BLink = _export_sfc(_sfc_main$1n, [["render", _sfc_render$d]]);
var linkProps$1 = omit(BLINK_PROPS, ["event", "routerTag"]);
var _sfc_main$1m = defineComponent({
  ...
  setup(props) {
    ...
    const classes = computed(() => ({
      ...
      "position-absolute top-0 start-100 translate-middle": textIndicatorBoolean.value || dotIndicatorBoolean.value,
      "p-2 border border-light rounded-circle": dotIndicatorBoolean.value,
      "text-decoration-none": link.value
    }));
    return {
      classes,
      props: link.value ? pluckProps(linkProps$1, props) : {},
      computedTag
    };
  }
});
...
var BBadge = _export_sfc(_sfc_main$1m, [["render", _sfc_render$c]]);
var _sfc_main$1l = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const computedTag = computed(() => activeBoolean.value ? "span" : "b-link");
    const computedAriaCurrent = computed(() => ({
      "aria-current": activeBoolean.value ? props.ariaCurrent : void 0
    }));
    const clicked = (e) => {
...
var BBreadcrumbItem = _export_sfc(_sfc_main$1l, [["render", _sfc_render$b]]);
var _hoisted_1$F = { "aria-label": "breadcrumb" };
var _hoisted_2$n = { class: "breadcrumb" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("nav", _hoisted_1$F, [
        createBaseVNode("ol", _hoisted_2$n, [
...
var BButton = _export_sfc(_sfc_main$1j, [["render", _sfc_render$a]]);
...
var _sfc_main$1g = defineComponent({
  ...
  setup(__props) {
    ...
    const imgClasses = computed(() => ({
      "card-img": !imgEndBoolean.value && !imgRightBoolean.value && !imgStartBoolean.value && !imgLeftBoolean.value && !imgTopBoolean.value && !imgTopBoolean.value,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          __props.imgSrc && !unref(imgBottomBoolean) ? (openBlock(), createElementBlock("img", mergeProps({ key: 0 }, unref(imgAttr), { class: unref(imgClasses) }), null, 16)) : createCommentVNode("", true),
          ...
          !unref(noBodyBoolean) ? (openBlock(), createBlock(resolveDynamicComponent(__props.bodyTag), {
            key: 2,
            class: normalizeClass([__props.bodyClass, unref(bodyClasses)])
          }, {
            default: withCtx(() => [
              __props.title && !unref(noBodyBoolean) ? (openBlock(), createBlock(resolveDynamicComponent(__props.titleTag), {
                key: 0,
                class: "card-title"
              }, {
                default: withCtx(() => [
              ...
              __props.subTitle && !unref(noBodyBoolean) ? (openBlock(), createBlock(resolveDynamicComponent(__props.subTitleTag), {
                key: 1,
          ...
          unref(noBodyBoolean) ? renderSlot(_ctx.$slots, "default", { key: 3 }) : createCommentVNode("", true),
          __props.footer || _ctx.$slots.footer || __props.footerHtml ? (openBlock(), createBlock(resolveDynamicComponent(__props.footerTag), {
            ...
            default: withCtx(() => [
              ...
              }, null, 8, _hoisted_2$m)) : renderSlot(_ctx.$slots, "footer", { key: 1 }, () => [
                createTextVNode(toDisplayString(__props.footer), 1)
              ])
            ]),
            _: 3
          }, 8, ["class"])) : createCommentVNode("", true),
          __props.imgSrc && unref(imgBottomBoolean) ? (openBlock(), createElementBlock("img", mergeProps({ key: 5 }, unref(imgAttr), { class: unref(imgClasses) }), null, 16)) : createCommentVNode("", true)
        ]),
        _: 3
      }, 8, ["class"]);
    };
...
var _sfc_main$1d = defineComponent({
  ...
  setup(__props) {
    const props = __props;
    useBooleanish(toRef(props, "overlay"));
    const classes = computed(() => ({
      [`text-${props.bodyTextVariant}`]: props.bodyTextVariant,
      [`bg-${props.bodyBgVariant}`]: props.bodyBgVariant
    }));
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.bodyTag), {
        ...
        default: withCtx(() => [
          __props.title ? (openBlock(), createBlock(_sfc_main$1f, {
            key: 0,
            "title-tag": __props.titleTag,
            title: __props.title
          }, null, 8, ["title-tag", "title"])) : createCommentVNode("", true),
          __props.subTitle ? (openBlock(), createBlock(_sfc_main$1e, {
            key: 1,
...
var _sfc_main$18 = {};
var _hoisted_1$A = { class: "card-text" };
function _sfc_render$9(_ctx, _cache) {
  return openBlock(), createElementBlock("p", _hoisted_1$A, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var BCardText = _export_sfc(_sfc_main$18, [["render", _sfc_render$9]]);
var _hoisted_1$z = ["id"];
var _hoisted_2$l = {
  key: 0,
  class: "carousel-indicators"
};
var _hoisted_3$8 = ["data-bs-target", "data-bs-slide-to", "aria-label"];
var _hoisted_4$5 = { class: "carousel-inner" };
var _hoisted_5$5 = ["data-bs-target"];
var _hoisted_6$3 = createBaseVNode("span", {
  class: "carousel-control-prev-icon",
  "aria-hidden": "true"
}, null, -1);
var _hoisted_7$2 = createBaseVNode("span", { class: "visually-hidden" }, "Previous", -1);
var _hoisted_8$2 = [
  _hoisted_6$3,
  _hoisted_7$2
];
var _hoisted_9$2 = ["data-bs-target"];
var _hoisted_10$2 = createBaseVNode("span", {
  class: "carousel-control-next-icon",
  "aria-hidden": "true"
}, null, -1);
var _hoisted_11$2 = createBaseVNode("span", { class: "visually-hidden" }, "Next", -1);
var _hoisted_12$2 = [
  _hoisted_10$2,
  _hoisted_11$2
];
...
var _sfc_main$17 = defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    useBooleanish(toRef(props, "noWrap"));
    const slots = useSlots();
    const element = ref();
    const instance = ref();
    const computedId = useId(toRef(props, "id"), "accordion");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(indicatorsBoolean) ? (openBlock(), createElementBlock("div", _hoisted_2$l, [
        ...
        unref(controlsBoolean) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
var _hoisted_1$y = ["id", "data-bs-interval"];
var _hoisted_2$k = { key: 0 };
var _hoisted_3$7 = ["innerHTML"];
var _hoisted_4$4 = { key: 0 };
...
var _sfc_main$16 = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        id: unref(computedId),
        class: normalizeClass(["carousel-item", { active: unref(activeBoolean) }]),
        ...
        __props.caption || __props.captionHtml || __props.text || __props.textHtml || _ctx.$slots.default ? (openBlock(), createBlock(resolveDynamicComponent(__props.contentTag), {
          ...
          default: withCtx(() => [
            __props.caption || __props.captionHtml ? (openBlock(), createBlock(resolveDynamicComponent(__props.captionTag), { key: 0 }, {
              default: withCtx(() => [
                unref(showCaption) ? (openBlock(), createElementBlock("span", _hoisted_2$k, toDisplayString(__props.caption), 1)) : createCommentVNode("", true),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        disabled: unref(disabledBoolean),
        "aria-label": "Close"
...
var _sfc_main$14 = defineComponent({
  ...
  setup(props) {
    ...
    const classList = properties.flatMap(
      (el) => getClasses$1(props, el.content, el.propPrefix, el.classPrefix)
    );
    const classes = computed(() => ({
...
var ToastController = class {
  constructor() {
    __publicField(this, "vms");
    __publicField(this, "rootInstance");
  ...
  setup(props, { slots, expose }) {
    ...
    return () => {
      ...
      toastInstance == null ? void 0 : toastInstance.containerPositions.value.forEach((position) => {
        subContainers.push(h(_sfc_main$13, { key: position, instance: toastInstance, position }));
      });
...
var _hoisted_1$w = { class: "visually-hidden" };
var _hoisted_2$j = ["aria-labelledby", "role"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(BButton, mergeProps({
          ...
          size: __props.size,
          class: [unref(buttonClasses), unref(splitBoolean) ? __props.splitClass : __props.toggleClass],
          disabled: unref(disabledBoolean),
        ...
        unref(splitBoolean) ? (openBlock(), createBlock(BButton, mergeProps({
          key: 0,
          ...
          default: withCtx(() => [
            createBaseVNode("span", _hoisted_1$w, toDisplayString(__props.toggleText), 1)
          ]),
          _: 1
...
var _hoisted_1$v = { role: "presentation" };
...
var _sfc_main$$ = {};
var _hoisted_1$u = { role: "presentation" };
var _hoisted_2$i = { class: "px-4 py-3" };
function _sfc_render$7(_ctx, _cache) {
  return openBlock(), createElementBlock("li", _hoisted_1$u, [
    createBaseVNode("form", _hoisted_2$i, [
      renderSlot(_ctx.$slots, "default")
    ])
  ]);
}
var BDropdownForm = _export_sfc(_sfc_main$$, [["render", _sfc_render$7]]);
var _hoisted_1$t = { role: "presentation" };
var _hoisted_2$h = ["id", "aria-describedby"];
var __default__$4 = {
  inheritAttrs: false
};
var _sfc_main$_ = defineComponent({
  ...
  setup(__props) {
    ...
    const headerId = computed(
      () => props.id ? [props.id, "group_dd_header"].join("_") : void 0
    );
    const headerRole = computed(
      () => props.headerTag === "header" ? void 0 : "heading"
    );
    const classes = computed(() => ({
...
var _sfc_main$Z = {};
var _hoisted_1$s = { class: "dropdown-header" };
function _sfc_render$6(_ctx, _cache) {
  return openBlock(), createElementBlock("li", null, [
    createBaseVNode("h6", _hoisted_1$s, [
      renderSlot(_ctx.$slots, "default")
    ])
  ]);
}
var BDropdownHeader = _export_sfc(_sfc_main$Z, [["render", _sfc_render$6]]);
...
var _hoisted_2$g = { class: "px-4 py-1 mb-0 text-muted" };
...
var BDropdownText = _export_sfc(_sfc_main$W, [["render", _sfc_render$5]]);
var _hoisted_1$o = ["id", "novalidate", "onSubmit"];
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", {
        id: __props.id,
        novalidate: unref(novalidateBoolean),
        class: normalizeClass(unref(classes)),
...
var _hoisted_1$n = { class: "form-floating" };
var _hoisted_2$f = ["for"];
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$n, [
        renderSlot(_ctx.$slots, "default"),
        createBaseVNode("label", { for: __props.labelFor }, toDisplayString(__props.label), 9, _hoisted_2$f)
      ]);
    };
  }
});
var _sfc_main$T = defineComponent({
  ...
  setup(__props) {
    ...
    const stateBoolean = props.state !== void 0 ? useBooleanish(toRef(props, "state")) : computed(() => void 0);
...
var _hoisted_1$m = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "aria-required", "value", "indeterminate"];
var _hoisted_2$e = ["for"];
var __default__$1 = {
  inheritAttrs: false
};
var _sfc_main$P = defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const indeterminateBoolean = props.indeterminate !== void 0 ? useBooleanish(toRef(props, "indeterminate")) : computed(() => void 0);
    ...
    const disabledBoolean = useBooleanish(toRef(props, "disabled"));
    const inlineBoolean = useBooleanish(toRef(props, "inline"));
    const requiredBoolean = props.required !== void 0 ? useBooleanish(toRef(props, "required")) : computed(() => void 0);
    const stateBoolean = props.state !== void 0 ? useBooleanish(toRef(props, "state")) : computed(() => void 0);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        withDirectives(createBaseVNode("input", mergeProps({ id: unref(computedId) }, _ctx.$attrs, {
          ...
          type: "checkbox",
          disabled: unref(disabledBoolean),
          required: !!__props.name && !!unref(requiredBoolean),
          name: __props.name,
          form: __props.form,
          "aria-label": __props.ariaLabel,
          "aria-labelledby": __props.ariaLabelledBy,
          "aria-required": __props.name && unref(requiredBoolean) ? "true" : void 0,
          value: __props.value,
          indeterminate: unref(indeterminateBoolean),
        ...
        _ctx.$slots.default || !unref(plainBoolean) ? (openBlock(), createElementBlock("label", {
          key: 0,
...
var _sfc_main$O = defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    useBooleanish(toRef(props, "autofocus"));
    const buttonsBoolean = useBooleanish(toRef(props, "buttons"));
    const disabledBoolean = useBooleanish(toRef(props, "disabled"));
    useBooleanish(toRef(props, "plain"));
    ...
    const checkboxList = computed(
      () => (slots.first ? slotsToElements(slots.first(), slotsName, disabledBoolean.value) : []).concat(props.options.map((e) => optionToElement(e, props))).concat(slots.default ? slotsToElements(slots.default(), slotsName, disabledBoolean.value) : []).map((e, idx) => bindGroupProps(e, idx, props, computedName, computedId)).map((e) => ({
        ...e,
        props: {
          ...
          return openBlock(), createBlock(_sfc_main$P, mergeProps({
            ...
            default: withCtx(() => [
              item.html ? (openBlock(), createElementBlock("span", {
                key: 0,
                innerHTML: item.html
              }, null, 8, _hoisted_2$d)) : (openBlock(), createElementBlock("span", {
                key: 1,
...
var _sfc_main$N = defineComponent({
  components: { BCol, BFormInvalidFeedback: _sfc_main$T, BFormRow: _sfc_main$S, BFormText: _sfc_main$R, BFormValidFeedback: _sfc_main$Q },
  props: {
  ...
  render() {
    ...
    if (!this.isHorizontal && this.floatingBoolean)
    ...
    if (this.isHorizontal && !isFieldset) {
      return h(_sfc_main$S, rowProps, { default: () => [$label, $content] });
    }
    return h(
      isFieldset ? "fieldset" : "div",
      rowProps,
      this.isHorizontal && isFieldset ? [h(_sfc_main$S, {}, { default: () => [$label, $content] })] : this.isHorizontal || !this.floatingBoolean ? [$label, $content] : [$content]
    );
  }
});
var allowedTypes = [
...
var _hoisted_1$k = ["id", "name", "form", "type", "disabled", "placeholder", "required", "autocomplete", "readonly", "min", "max", "step", "list", "aria-required", "aria-invalid"];
...
var BFormInput = _export_sfc(_sfc_main$M, [["render", _sfc_render$4]]);
var _hoisted_1$j = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "value", "aria-required"];
var _hoisted_2$c = ["for"];
...
var _hoisted_1$h = ["value", "disabled"];
...
var _sfc_main$I = defineComponent({
  ...
  setup(__props) {
    ...
    const formOptions = computed(
      () => normalizeOptions(props.options, "BFormSelectOptionGroup", props)
    );
    return (_ctx, _cache) => {
...
var _hoisted_1$f = ["id", "name", "form", "multiple", "size", "disabled", "required", "aria-required", "aria-invalid"];
var _sfc_main$H = defineComponent({
  __name: "BFormSelect",
  props: {
    ariaInvalid: { default: false },
    autofocus: { default: false },
    disabled: { default: false },
    disabledField: { default: "disabled" },
    form: null,
  ...
  setup(__props, { expose, emit }) {
    ...
    const formOptions = computed(
      () => normalizeOptions(props.options, "BFormSelect", props)
    );
    const localValue = computed({
      get() {
        return props.modelValue;
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("select", mergeProps({
        ...
        multiple: unref(multipleBoolean) || void 0,
        size: unref(computedSelectSize),
        disabled: unref(disabledBoolean),
        required: unref(requiredBoolean),
        "aria-required": unref(requiredBoolean) ? true : void 0,
        "aria-invalid": unref(computedAriaInvalid)
      }), [
        renderSlot(_ctx.$slots, "first"),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(formOptions), (option, index) => {
          return openBlock(), createElementBlock(Fragment, null, [
            Array.isArray(option.options) ? (openBlock(), createBlock(_sfc_main$I, {
              key: `option_${index}`,
              label: option.label,
              options: option.options
            }, null, 8, ["label", "options"])) : (openBlock(), createBlock(_sfc_main$J, {
              key: `option2_${index}`,
              value: option.value,
              disabled: option.disabled,
              innerHTML: option.html || option.text
...
var _hoisted_1$e = ["id"];
var _hoisted_2$a = ["aria-label", "aria-controls", "aria-describedby"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          ...
          !unref(disabledBoolean) && !unref(noRemoveBoolean) ? (openBlock(), createElementBlock("button", {
            key: 0,
...
var _hoisted_1$d = ["id"];
var _hoisted_2$9 = ["id", "for", "aria-live"];
var _hoisted_3$4 = ["id", "aria-live"];
var _hoisted_4$3 = ["id"];
var _hoisted_5$3 = ["aria-controls"];
var _hoisted_6$2 = {
  role: "group",
  class: "d-flex"
};
var _hoisted_7$1 = ["id", "disabled", "value", "type", "placeholder", "form", "required"];
...
var _sfc_main$F = defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const onKeydown = (e) => {
      ...
      if ((e.key === "Backspace" || e.key === "Delete") && removeOnDeleteBoolean.value && inputValue.value === "" && shouldRemoveOnDelete.value && tags.value.length > 0) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        }, toDisplayString(tags.value.join(", ")), 9, _hoisted_2$9),
        createBaseVNode("div", {
          ...
          "aria-atomic": "true",
          class: "visually-hidden"
        }, " (" + toDisplayString(__props.tagRemovedLabel) + ") " + toDisplayString(lastRemovedTag.value), 9, _hoisted_3$4),
            ...
            createBaseVNode("li", {
              ...
              createBaseVNode("div", _hoisted_6$2, [
                ...
                unref(disableAddButton) ? (openBlock(), createElementBlock("button", {
                  ...
                  style: { "font-size": "90%" },
                  disabled: unref(disabledBoolean) || inputValue.value.length === 0 || unref(isLimitReached),
...
var _sfc_main$E = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const computedStyles = computed(
      () => noResizeBoolean.value ? { resize: "none" } : void 0
    );
    const { input, computedId, computedAriaInvalid, onInput, onChange, onBlur, focus: focus2, blur } = useFormInput(props, emit);
    return {
      input,
...
var _hoisted_1$c = ["id", "name", "form", "disabled", "placeholder", "required", "autocomplete", "readonly", "aria-required", "aria-invalid", "rows", "wrap"];
...
var BFormTextarea = _export_sfc(_sfc_main$E, [["render", _sfc_render$3]]);
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "prepend", {}, () => [
            unref(hasPrepend) ? (openBlock(), createElementBlock("span", _hoisted_1$b, [
              !unref(showPrependHtml) ? (openBlock(), createElementBlock("span", _hoisted_2$8, toDisplayString(__props.prepend), 1)) : createCommentVNode("", true),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          unref(isTextBoolean) ? (openBlock(), createBlock(_sfc_main$B, { key: 0 }, {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main$w = defineComponent({
  ...
  setup(__props) {
    ...
    const link = computed(() => !buttonBoolean.value && (!!props.href || !!props.to));
    const tagComputed = computed(
      () => (parentData == null ? void 0 : parentData.numbered) ? "li" : buttonBoolean.value ? "button" : !link.value ? props.tag : BLink
    );
    const classes = computed(() => {
      const action = actionBoolean.value || link.value || buttonBoolean.value || ["a", "router-link", "button", "b-link"].includes(props.tag);
      return {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(unref(tagComputed)), mergeProps({
        ...
        "aria-current": unref(activeBoolean) ? true : null,
        "aria-disabled": unref(disabledBoolean) ? true : null,
        target: unref(link) ? __props.target : null,
        href: !unref(buttonBoolean) ? __props.href : null,
        to: !unref(buttonBoolean) ? __props.to : null
      }, unref(computedAttrs)), {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
  ...
  setup(__props, { emit }) {
    ...
    onMounted(() => {
      ...
      instance.value = new import_modal.default(element.value, {
        backdrop: hideBackdropBoolean.value ? false : noCloseOnBackdropBoolean.value ? "static" : !hideBackdropBoolean.value,
    ...
    watch(
      ...
      (newValue) => {
        instance.value._config.backdrop = props.hideBackdrop ? false : newValue ? "static" : !props.hideBackdrop;
      }
    );
    watch(
      () => props.noCloseOnEsc,
      (newValue) => {
        instance.value._config.keyboard = !newValue;
      }
    );
    watch(
      () => modelValueBoolean.value,
        ...
        createBaseVNode("div", mergeProps({
          ...
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              ...
              !unref(hideHeaderBoolean) ? (openBlock(), createElementBlock("div", {
                key: 0,
                ...
                !unref(hideHeaderCloseBoolean) ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  type: "button",
              ...
              !unref(hideFooterBoolean) ? (openBlock(), createElementBlock("div", {
                key: 1,
                class: normalizeClass(["modal-footer", unref(computedFooterClasses)])
              }, [
                renderSlot(_ctx.$slots, "footer", {}, () => [
                  !unref(okOnlyBoolean) ? (openBlock(), createBlock(BButton, {
                    key: 0,
                    type: "button",
                    class: "btn",
                    "data-bs-dismiss": "modal",
...
var _sfc_main$t = defineComponent({
  ...
  setup(__props) {
    ...
    const computedRole = computed(
      () => props.tag === "nav" ? void 0 : "navigation"
    );
    const computedNavbarExpand = computed(
      () => props.toggleable && typeof props.toggleable === "string" ? `navbar-expand-${props.toggleable}` : props.toggleable === false ? "navbar-expand" : void 0
    );
    const classes = computed(() => ({
      ...
      [computedNavbarExpand.value]: computedNavbarExpand.value !== void 0
    }));
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        class: normalizeClass(["navbar", unref(classes)]),
        role: unref(computedRole)
      }, {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(resolveDynamicComponent(_ctx.computedTag), mergeProps({ class: "navbar-brand" }, _ctx.props), {
    default: withCtx(() => [
      renderSlot(_ctx.$slots, "default")
    ]),
    _: 3
...
var BNavbarBrand = _export_sfc(_sfc_main$s, [["render", _sfc_render$2]]);
var _sfc_main$r = defineComponent({
  __name: "BNavbarNav",
  props: {
    align: null,
  ...
  setup(__props) {
    ...
    const classes = computed(() => ({
      "nav-fill": fillBoolean.value,
      "nav-justified": justifiedBoolean.value,
      [comptuedJustifyContent.value]: props.align !== void 0,
      "small": smallBoolean.value
    }));
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", {
        class: normalizeClass(["navbar-nav", unref(classes)])
      }, [
        renderSlot(_ctx.$slots, "default")
      ], 2);
    };
...
var resolvePlacement = (modifiers) => {
  if (modifiers.left) {
    return "left";
  }
  if (modifiers.right) {
...
var _hoisted_1$9 = createBaseVNode("span", { class: "navbar-toggler-icon" }, null, -1);
var _hoisted_2$6 = [
  _hoisted_1$9
];
var _sfc_main$q = defineComponent({
    ...
    const onClick = () => {
      if (!disabledBoolean.value) {
        ...
        if (props.target !== void 0) {
          ...
          el == null ? void 0 : el.classList.toggle("show");
        }
      }
    };
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("button", mergeProps({
        class: ["navbar-toggler", unref(classes)],
        type: ""
      }, unref(attrs), { onClick }), _hoisted_2$6, 16)), [
        [unref(BToggle)]
      ]);
    };
  }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", {
        ...
        createVNode(BLink, {
          href: __props.href,
          to: __props.to,
          class: normalizeClass(["nav-link", unref(classes)]),
          tabindex: unref(disabledBoolean) ? -1 : void 0,
          "aria-disabled": unref(disabledBoolean) ? true : void 0
        }, {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default")
          ]),
          _: 3
        }, 8, ["href", "to", "class", "tabindex", "aria-disabled"])
      ], 2);
    };
  }
});
var _hoisted_1$8 = { class: "nav-item dropdown" };
var _sfc_main$o = defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", _hoisted_1$8, [
        createVNode(_sfc_main$11, normalizeProps(guardReactiveProps(_ctx.$props)), createSlots({ _: 2 }, [
...
var _hoisted_1$7 = ["data-bs-backdrop", "data-bs-scroll"];
var _hoisted_2$5 = { class: "offcanvas-header" };
var _hoisted_3$2 = {
  id: "offcanvasLabel",
  class: "offcanvas-title"
};
var _hoisted_4$1 = createBaseVNode("button", {
  type: "button",
  class: "btn-close text-reset",
  "data-bs-dismiss": "offcanvas",
  "aria-label": "Close"
}, null, -1);
var _hoisted_5$1 = { class: "offcanvas-body" };
var _sfc_main$n = defineComponent({
  __name: "BOffcanvas",
  props: {
    modelValue: { default: false },
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        "data-bs-backdrop": unref(backdropBoolean),
        "data-bs-scroll": unref(bodyScrollingBoolean)
      }, [
        createBaseVNode("div", _hoisted_2$5, [
          createBaseVNode("h5", _hoisted_3$2, [
            renderSlot(_ctx.$slots, "title", {}, () => [
              createTextVNode(toDisplayString(__props.title), 1)
            ])
          ]),
...
var _sfc_main$l = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const computedRounded = computed(
      () => props.rounded === true || props.rounded === "" ? "rounded" : !props.rounded ? "" : `rounded-${props.rounded}`
    );
    const computedVariant = computed(
      ...
      if (showBoolean.value) {
        ...
        const $content = h(
          "div",
          {
            ...
            style: noCenterBoolean.value ? { ...POSITION_COVER } : { top: "50%", left: "50%", transform: "translateX(-50%) translateY(-50%)" }
          },
        ...
        $overlay = h(
          props.overlayTag,
          {
            class: [
              "b-overlay",
              {
                "position-absolute": !noWrapBoolean.value || noWrapBoolean.value && !fixedBoolean.value,
  ...
  setup(props, { emit, slots }) {
    ...
    return () => {
      ...
      const makeEndBtn = (linkTo, ariaLabel, btnSlot, btnText, btnClass, pageTest) => {
        const isDisabled = disabledBoolean.value || isActivePage(pageTest) || noCurrentPage || linkTo < 1 || linkTo > numberOfPages.value;
      ...
      const makePageButton = (page, idx) => {
        ...
        const tabIndex = disabledBoolean.value ? null : active || noCurrentPage && idx === 0 ? "0" : "-1";
        const scope = {
          active,
          disabled: disabledBoolean.value,
          page: page.number,
      ...
      pages.value.forEach((page, idx) => {
        const offset2 = showFirstDots.value && firstNumberBoolean.value && pageNumbers[0] !== 1 ? 1 : 0;
...
var _sfc_main$j = defineComponent({
  ...
  setup(props, { emit, slots }) {
    useBooleanish(toRef(props, "noninteractive"));
    const showBoolean = useBooleanish(toRef(props, "show"));
...
var _hoisted_1$6 = ["id"];
var _hoisted_2$4 = { ref: "titleRef" };
var _hoisted_3$1 = { ref: "contentRef" };
...
var BPopover = _export_sfc(_sfc_main$j, [["render", _sfc_render$1]]);
var _sfc_main$i = defineComponent({
  props: {
  ...
  setup(props, { slots }) {
    ...
    const classes = computed(() => ({
      "progress-bar-animated": animatedBoolean.value || (parent == null ? void 0 : parent.animated),
      "progress-bar-striped": stripedBoolean.value || (parent == null ? void 0 : parent.striped) || animatedBoolean.value || (parent == null ? void 0 : parent.animated),
      [`bg-${props.variant}`]: props.variant
    }));
    const computedLabel = computed(() => {
      if (showValueBoolean.value || (parent == null ? void 0 : parent.showValue)) {
        return parseFloat(props.value).toFixed(props.precision);
      }
      if (showProgressBoolean.value || (parent == null ? void 0 : parent.showProgress)) {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "default", {}, () => [
          createVNode(_sfc_main$i, normalizeProps(guardReactiveProps({
            animated: unref(animatedBoolean),
            max: __props.max,
            precision: __props.precision,
            showProgress: unref(showProgressBoolean),
            showValue: unref(showValueBoolean),
            striped: unref(stripedBoolean),
            value: __props.value,
            variant: __props.variant
          })), null, 16)
        ])
...
var BRow = _export_sfc(_sfc_main$g, [["render", _sfc_render]]);
var _sfc_main$f = defineComponent({
  __name: "BSkeleton",
  props: {
    height: null,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$d, normalizeProps(guardReactiveProps(__props.tableProps)), {
        default: withCtx(() => [
          !unref(hideHeaderBoolean) ? (openBlock(), createElementBlock("thead", _hoisted_1$5, [
          ...
          unref(showFooterBoolean) ? (openBlock(), createElementBlock("tfoot", _hoisted_2$3, [
            createBaseVNode("tr", null, [
...
var _sfc_main$b = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(loadingBoolean) ? renderSlot(_ctx.$slots, "loading", { key: 0 }) : renderSlot(_ctx.$slots, "default", { key: 1 });
    };
  }
});
var _hoisted_1$4 = {
...
var _hoisted_1$3 = ["id", "data-bs-target", "aria-controls", "aria-selected", "onClick"];
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          unref(endBoolean) ? (openBlock(), createElementBlock("div", {
            key: 0,
            ...
            unref(showEmpty) ? (openBlock(), createElementBlock("div", {
              key: "bv-empty-tab",
              class: normalizeClass(["tab-pane active", { "card-body": unref(cardBoolean) }])
            }, [
              renderSlot(_ctx.$slots, "empty")
            ], 2)) : createCommentVNode("", true)
          ], 2)) : createCommentVNode("", true),
          createBaseVNode("div", {
            class: normalizeClass([__props.navWrapperClass, { "card-header": unref(cardBoolean), "ms-auto": __props.vertical && unref(endBoolean) }])
          }, [
            createBaseVNode("ul", {
...
var _sfc_main$8 = defineComponent({
  ...
  setup(__props) {
    ...
    const computedLazy = computed(() => (parentData == null ? void 0 : parentData.lazy) || lazyBoolean.value);
    ...
    return (_ctx, _cache) => {
      return __props.responsive ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("table", {
          ...
          unref(footCloneBoolean) ? (openBlock(), createElementBlock("tfoot", _hoisted_3, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(computedFields), (field) => {
                return openBlock(), createElementBlock("th", mergeProps({
                  key: field.key
        ...
        unref(footCloneBoolean) ? (openBlock(), createElementBlock("tfoot", _hoisted_9, [
          createBaseVNode("tr", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(computedFields), (field) => {
              return openBlock(), createElementBlock("th", mergeProps({
                key: field.key
...
var _hoisted_1$1 = ["scope", "colspan", "rowspan", "data-label"];
...
var _sfc_main$4 = defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const footVariantBoolean = props.footVariant !== void 0 ? useBooleanish(toRef(props, "footVariant")) : computed(() => void 0);
    const classes = computed(() => ({
...
var _hoisted_1 = ["scope", "colspan", "rowspan", "data-label"];
...
var _sfc_main = defineComponent({
  ...
  setup(props, { emit, slots }) {
    useBooleanish(toRef(props, "animation"));
    ...
    useBooleanish(toRef(props, "solid"));
    useBooleanish(toRef(props, "static"));
    const modelValueBoolean = useBooleanish(toRef(props, "modelValue"));
...
var Components = {
  BAccordion: _sfc_main$1t,
  BAccordionItem: _sfc_main$1r,
  BAlert: _sfc_main$1q,
  BAvatar: _sfc_main$1o,
  BAvatarGroup: _sfc_main$1p,
  BBadge,
  BBreadcrumb: _sfc_main$1k,
  BBreadcrumbItem,
  BButton,
  BButtonGroup: _sfc_main$1i,
  BButtonToolbar: _sfc_main$1h,
  BCard: _sfc_main$1g,
  BCardBody: _sfc_main$1d,
  BCardFooter: _sfc_main$1c,
  BCardGroup: _sfc_main$1b,
  BCardHeader: _sfc_main$1a,
  BCardImg: _sfc_main$19,
  BCardSubTitle: _sfc_main$1e,
  BCardText,
  BCardTitle: _sfc_main$1f,
  BCarousel: _sfc_main$17,
  BCarouselSlide: _sfc_main$16,
  BCloseButton: _sfc_main$15,
  BCol,
  BCollapse: _sfc_main$1s,
  BContainer: _sfc_main$12,
  BDropdown: _sfc_main$11,
  BDropdownDivider: _sfc_main$10,
  BDropdownForm,
  BDropdownGroup: _sfc_main$_,
  BDropdownHeader,
  BDropdownItem: _sfc_main$Y,
  BDropdownItemButton: _sfc_main$X,
  BDropdownText,
  BForm: _sfc_main$V,
  BFormCheckbox: _sfc_main$P,
  BFormCheckboxGroup: _sfc_main$O,
  BFormFloatingLabel: _sfc_main$U,
  BFormGroup: _sfc_main$N,
  BFormInput,
  BFormInvalidFeedback: _sfc_main$T,
  BFormRadio: _sfc_main$L,
  BFormRadioGroup: _sfc_main$K,
  BFormRow: _sfc_main$S,
  BFormSelect: _sfc_main$H,
  BFormSelectOption: _sfc_main$J,
  BFormSelectOptionGroup: _sfc_main$I,
  BFormText: _sfc_main$R,
  BFormTextarea,
  BFormTag: _sfc_main$G,
  BFormTags: _sfc_main$F,
  BFormValidFeedback: _sfc_main$Q,
  BImg: _sfc_main$D,
  BInputGroup: _sfc_main$C,
  BInputGroupAddon: _sfc_main$A,
  BInputGroupAppend: _sfc_main$z,
  BInputGroupPrepend: _sfc_main$y,
  BInputGroupText: _sfc_main$B,
  BLink,
  BListGroup: _sfc_main$x,
  BListGroupItem: _sfc_main$w,
  BModal: _sfc_main$v,
  BNav: _sfc_main$u,
  BNavbar: _sfc_main$t,
  BNavbarBrand,
  BNavbarNav: _sfc_main$r,
  BNavbarToggle: _sfc_main$q,
  ...
  BTr: _sfc_main$1,
  BToast: _sfc_main,
  BToaster: _sfc_main$13,
  BToastContainer: _sfc_main$13,
  BTabs: _sfc_main$9,
...
export {
  _sfc_main$1t as BAccordion,
  _sfc_main$1r as BAccordionItem,
  _sfc_main$1q as BAlert,
  _sfc_main$1o as BAvatar,
  _sfc_main$1p as BAvatarGroup,
  BBadge,
  _sfc_main$1k as BBreadcrumb,
  BBreadcrumbItem,
  BButton,
  _sfc_main$1i as BButtonGroup,
  _sfc_main$1h as BButtonToolbar,
  _sfc_main$1g as BCard,
  _sfc_main$1d as BCardBody,
  _sfc_main$1c as BCardFooter,
  _sfc_main$1b as BCardGroup,
  _sfc_main$1a as BCardHeader,
  _sfc_main$19 as BCardImg,
  _sfc_main$1e as BCardSubTitle,
  BCardText,
  _sfc_main$1f as BCardTitle,
  _sfc_main$17 as BCarousel,
  _sfc_main$16 as BCarouselSlide,
  _sfc_main$15 as BCloseButton,
  BCol,
  _sfc_main$1s as BCollapse,
  _sfc_main$12 as BContainer,
  _sfc_main$11 as BDropdown,
  _sfc_main$10 as BDropdownDivider,
  BDropdownForm,
  _sfc_main$_ as BDropdownGroup,
  BDropdownHeader,
  _sfc_main$Y as BDropdownItem,
  _sfc_main$X as BDropdownItemButton,
  BDropdownText,
  _sfc_main$V as BForm,
  _sfc_main$P as BFormCheckbox,
  _sfc_main$O as BFormCheckboxGroup,
  _sfc_main$U as BFormFloatingLabel,
  _sfc_main$N as BFormGroup,
  BFormInput,
  _sfc_main$T as BFormInvalidFeedback,
  _sfc_main$L as BFormRadio,
  _sfc_main$K as BFormRadioGroup,
  _sfc_main$S as BFormRow,
  _sfc_main$H as BFormSelect,
  _sfc_main$J as BFormSelectOption,
  _sfc_main$I as BFormSelectOptionGroup,
  _sfc_main$G as BFormTag,
  _sfc_main$F as BFormTags,
  _sfc_main$R as BFormText,
  BFormTextarea,
  _sfc_main$Q as BFormValidFeedback,
  _sfc_main$D as BImg,
  _sfc_main$C as BInputGroup,
  _sfc_main$A as BInputGroupAddon,
  _sfc_main$z as BInputGroupAppend,
  _sfc_main$y as BInputGroupPrepend,
  _sfc_main$B as BInputGroupText,
  BLink,
  _sfc_main$x as BListGroup,
  _sfc_main$w as BListGroupItem,
  _sfc_main$v as BModal,
  _sfc_main$u as BNav,
  _sfc_main$p as BNavItem,
  _sfc_main$o as BNavItemDropdown,
  _sfc_main$t as BNavbar,
  BNavbarBrand,
  _sfc_main$r as BNavbarNav,
  _sfc_main$n as BOffcanvas,
  _sfc_main$l as BOverlay,
  _sfc_main$k as BPagination,
  BPopover,
  _sfc_main$h as BProgress,
  _sfc_main$i as BProgressBar,
  BRow,
  _sfc_main$f as BSkeleton,
  _sfc_main$e as BSkeletonIcon,
  _sfc_main$c as BSkeletonTable,
  _sfc_main$b as BSkeletonWrapper,
  _sfc_main$a as BSpinner,
  _sfc_main$8 as BTab,
  _sfc_main$7 as BTable,
  _sfc_main$d as BTableSimple,
  _sfc_main$9 as BTabs,
  ...
  _sfc_main as BToast,
  _sfc_main$13 as BToastContainer,
  BToastPlugin,
  _sfc_main$13 as BToaster,
  _sfc_main$1 as BTr,
  _sfc_main$m as BTransition,
  plugin as BootstrapVue3,
  BvEvent,
  BPopover$1 as VBPopover,
  BToggle as VBToggle,
